...
def args_process():
    ...
    input_and_output.add_argument('-cs', '--compare_software', type=str, nargs=1,
                                  choices=['minimap2','winnowmap2','ngmlr','lra'],
                                  help=" choice of the required comparison software")
    ...
    general_option.add_argument('-msrr', '--minimum_support_reads_ratio', type=float, nargs=1,
                                default=[defaultPara_gt["minimum_support_reads_ratio"]],
                                help="minimum support reads ratio of an available microsatellite call[default:" +
                                     str(defaultPara_gt["minimum_support_reads_ratio"]) + "]")

    general_option.add_argument('-miv', '--mut_information_visual',
                                default=[defaultPara_gt["mut_information_visual"]],
                                type=str, nargs=1,help=" visualization results of mutation information")
    ...
    qc_input_and_output.add_argument('-cs', '--compar_software', type=str, nargs=1,
                                  choices=['minimap2','winnowmap2','ngmlr','lra'],
                                  required=True,
                                  help=" choice of the required comparison software")
