...
def genotype_init(args):
    ...
    paras['compare_software'] = args.compare_software[0]
    paras['mut_information_visual'] = args.mut_information_visual[0]
    paras['minimum_support_reads_ratio'] = args.minimum_support_reads_ratio[0]
    ...
    if not os.path.exists(paras["output"]):
        ...
        if paras["debug"]:
            ...
            error_stat = True
            print(paras["output"], "fkflflflflfflfl", error_stat)
